...
public class Gezin implements Serializable {
    ...
    public boolean isHuwelijkOp(Calendar datum) {
        //todo opgave 1       
        return huwelijksdatum != null && (huwelijksdatum.equals(datum) || (datum.after(huwelijksdatum) && datum.before(scheidingsdatum)) || (datum.after(huwelijksdatum) && scheidingsdatum == null));
    }
